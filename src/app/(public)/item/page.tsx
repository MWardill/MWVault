...
export default function Home() {
    return (
        <div className="h-full flex flex-col w-full relative">
            <div className="stippled jrpg-panel flex-1 flex flex-col pt-3 pb-6 px-4 md:pr-46 lg:pr-58">
                ...
                <div className="jrpg-panel mt-2 relative ![box-shadow:inset_0_0_0_2px_#7fc0ff,_inset_0_0_18px_rgba(255,255,255,0.15),_0_2px_12px_rgba(0,0,0,1.3)]">
                            ...
                            {items.map((item, idx) => (
                                <div key={idx} className="flex justify-between items-center group cursor-pointer px-2 py-1 hover:bg-white/5 rounded-sm transition-colors relative z-20">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="drop-shadow-[1px_1px_0_rgba(0,0,0,0.8)] flex-shrink-0 flex items-center justify-center w-[32px] h-[32px]">
